...
/***************** Configuration *****************/
  ...
  $contact_email_to = "induspacsa@gmail.com";
  ...
  // Error messages
  $contact_error_name = "El nombre es demasiado corto!";
  $contact_error_email = "Porfavor ingrese un mail valido!";
  $contact_error_subject = "Asunto muy corto o vacio!";
  $contact_error_message = "El mensaje es muy corto!";
